       ...
       if ($queryResults2 > 0) {
           while ($row = mysqli_fetch_assoc($result2)) {
                if ($row['valor_nota']==1) {
                    ...
                    <img src='imagem/image-11.svg' alt='icone'>
                ...
                elseif ($row['valor_nota']==2) {
                    ...
                    <div class='conservacao'>
                    <p id='nome-avaliacao'> Conservação do imóvel </p>
                    <img src='imagem/image-22.svg' alt='icone'>
                ...
                elseif ($row['valor_nota']==3) {
                    ...
                    <div class='conservacao'>
                    <p id='nome-avaliacao'> Conservação do imóvel </p>
                    <img src='imagem/image-33.svg' alt='icone'>
                ...
                elseif ($row['valor_nota']==4) {
                    ...
                    <div class='conservacao'>
                    <p id='nome-avaliacao'> Conservação do imóvel </p>
                    <img src='imagem/image-44.svg' alt='icone'>
                    <p id='conceito'> Bom! </p>
                    </div>";
                }
                else {
                    ...
                    <div class='conservacao'>
                    <p id='nome-avaliacao'> Conservação do imóvel </p>
                    <img src='imagem/image-55.svg' alt='icone'>
